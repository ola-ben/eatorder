...
export default function Checkoutpage() {
  ...
  return (
    <section className=" font-montserrat mx-1.5 my-1.5">
      ...
      <form className="">
        <div className="bg-[#f6f4f9] p-5 rounded-[12px] mx-3.5">
          <p className="capitalize mb-4">fullfillment option</p>

          <div className="">
            <button className="flex items-center gap-4 ">
              <FaRegDotCircle className="bg-ph" />
              <p>Pickup</p>
            </button>
            <button className="flex items-center gap-4">
              <FaRegDotCircle />
        ...
        <div className="bg-[#f6f4f9] p-5 rounded-[12px] mx-3.5 my-10">
          <p className="capitalize mb-4">fullfillment option</p>
          <div className="grid grid-cols-1  font-medium text-gray-700 text-[15px]  md:text-xl lg:text-[17px]">
            ...
            <input
              type="text"
              required
              className="w-full bg-white border rounded-[10px] p-2 border-gray-400 focus:border-ph focus:outline-none"
            />
          </div>
          ...
          <div className="grid grid-cols-1  font-medium text-gray-700 text-[15px]  md:text-xl lg:text-[17px]">
            ...
            <input
              type="text"
              required
              className="w-full bg-white border rounded-[10px] p-2 border-gray-400 focus:border-ph focus:outline-none mb-4"
            />
          </div>
        </div>
        <div className="bg-[#f6f4f9] p-5 rounded-[12px] mx-3.5 my-10">
